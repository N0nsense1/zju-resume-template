...
\setlength{\intraProjectTitleSep}{0.9em} % <--- 在此调整标题和描述的距离
...
\section{\makebox[\widthof{\faInfo}][c]{\color{CVBlue}\faInfo}\ 竞赛经历和自学课程}
\begin{itemize}[nosep]
    \item \textbf{竞赛经历}: ZJU HPCWeek 新生奖(后通过面试加入超算队); 上海交通大学荣昶杯AI应用开发赛道
    \item \textbf{自学课程}: MIT Missing Semester; MIT Introduction to Algorithmn; UCB CS61A \& CS61C
\end{itemize}
...
\begin{itemize}[nosep]
    ...
    \item \textbf{学习方向}: 科学计算优化: OpenMP, SIMD, CUDA; AI推理和训练加速: Pytorch, 分布式训练
\end{itemize}
