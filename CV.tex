...
\begin{itemize}[nosep]
    \item \textbf{自主学习能力}: 通过 d2l 自学图像训练数据处理，在 SJTU 夏令营的 ai 开发赛道中负责数据处理和预训练，带领团队获奖；自学基本开发工具和高性能计算知识，参与 HPC 校赛并获奖，通过面试遴选进入 ZJUSCT；寒假时自学代理软件配置知识，解决校网和科学上网工具冲突；假期通过 MIT opencourse 学习算法和数理基础知识，同时补全自己的英语术语库。
    \item \textbf{实践与解决问题}: 主动研究硬件配置，独立完成装机与日常维护；善于利用工具优化工作流，如配置代理解决校网和代理冲突问题。
    \item \textbf{行业视野}: 有定期阅读技术博客的习惯；平时喜欢听业界学界人物的访谈播客，了解前沿理论和工业界进展，对新知识新想法保持开放和持续学习的态度。
\end{itemize}
