...
\textbf{基于Mediapipe的石头剪刀布联机对战} \hfill 2024.05 -- 2024.06 \titlebreak
项目描述：在技术博客上刷到mediapipe的用法后产生兴趣，遂利用周末的时间断断续续地完成了这个项目,主要利用了mediapipe预训练的神经网络做了手势识别。
% 在 itemize 的选项中，使用 topsep=\intraProjectListTopSep 来控制上边距
\begin{itemize}[nosep, topsep=\intraProjectListTopSep]
    \item \textbf{数据采集}：运用 \textbf{Go} 语言及 \textbf{GORM} 框架，实现对全站“烂坑”帖的7x24小时全天候\textbf{抓取}与\textbf{入库}(MySQL)。
    \item \textbf{可视化UI}：采用原生 \textbf{HTML/CSS/JS} 构建了“烂坑”实时监控\textbf{作战大屏}。实现了坑主成分分析、挖坑热力图、年度烂坑王榜单等\textbf{可视化图表}，并通过 \textbf{AJAX} 异步刷新，确保数据洞察的实时性。
